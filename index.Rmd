...
# Ocorrência e sazonalidade de focos de queimada nas microrregiões do Matopiba
...
```{r grafico2, fig.height = 15, fig.width= 3,echo=FALSE, fig.cap="Gráfico polar de número de focos de queimadas por km² mensais por microrregião no período de 2011 a 2021", message=FALSE, warning=FALSE, , fig.align='center', out.width="100%"}
